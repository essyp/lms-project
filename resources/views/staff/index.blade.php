...
<div id="content" class="ui-content ui-content-aside-overlay">
            ...
            <div class="ui-content-body">
                ...
                <div class="ui-container">
                    <div class="row">
                    <form id="status_form" action='{{url("staff/bulk-action")}}' method="POST">
                        {{ csrf_field() }}
                        <div class="col-sm-12">
                            <div class="mbot-20">
                                    <div class="btn-group">
                                    ...
                                    <button type="button" data-toggle="modal" data-target="#import" class="btn btn-default">Import Staff</button>
                                    <button type="button" data-toggle="modal" data-target="#import-edit" class="btn btn-default">Import & Edit</button>
                                    <a type="button" href="{{url('staff/download-template')}}" class="btn btn-default">Download Template</a>
                                    <button type="button" data-toggle="modal" data-target="#new_staff" class="btn btn-default">New Staff</button>
...
<div  id="import-edit" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <form class="cmxform form-horizontal" action="{{url('staff/import/edit')}}" enctype="multipart/form-data" method="POST">
                @csrf
                <div class="modal-body">
                    <div class="form">
...
<div  id="export" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <form class="cmxform form-horizontal" action="{{url('staff/export')}}" method="POST">
                @csrf
                <div class="modal-body">
                    <div class="form">
                        <div class="form-group">
...
<!-- create modal -->
<div  id="new_staff" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
            ...
            {{ csrf_field() }}
                <div class="modal-body">
                    <div class="form">
                        <div class="form-group">
                            <label for="title" class="control-label col-lg-3">Staff No</label>
                            <div class="col-lg-9">
                                <input class=" form-control" name="staff_no" type="text" required="required"/>
                            </div>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-lg-9">
                                <input class=" form-control" name="middle_name" type="text" required="required"/>
                            </div>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            <label for="title" class="control-label col-lg-3">Role</label>
                            <div class="col-lg-9">
                        ...
                        <div class="form-group">
                            <label for="title" class="control-label col-lg-3">Position</label>
                            <div class="col-lg-9">
...
<div  id="editmodal" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                <h4 class="modal-title" id="myModalLabel">Update Staff</h4>
            </div>
                ...
                <div class="modal-body">
                    <div class="form">
                        ...
                        <div class="form-group">
                            <label for="title" class="control-label col-lg-3">Middle Name</label>
                            <div class="col-lg-9">
                                <input class=" form-control" id="edit_middle_name" name="middle_name" type="text"/>
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="title" class="control-label col-lg-3">Email Address</label>
                        ...
                        <div class="form-group">
                            <label for="title" class="control-label col-lg-3">Role</label>
                            <div class="col-lg-9">
                                <select class=" form-control" id="edit_role_id" name="role_id" required="required">
                                    <option disabled selected>select role</option>
                                    @foreach($roles as $role)
                                    <option value="{{$role->id}}">{{$role->name}}</option>
                                    @endforeach
                        ...
                        <div class="form-group">
                            <label for="title" class="control-label col-lg-3">Position</label>
                            <div class="col-lg-9">
                                <input class=" form-control" id="edit_position" name="position" type="text" required="required"/>
                            </div>
                        </div>
                    </div>
                </div>
...
<script>
		...
		$.ajax({
			...
			success: function(data){
				...
				if(data.status == "success"){
                    ...
                    $( "#datatable" ).load( "{{url('staff/history')}} #datatable" );
    ...
    function update(event){
        ...
        $('#edit_role_id').val(event.role_id)
        $('#edit_position').val(event.position)
    ...
    $('#create-form').submit(function(e){
        e.preventDefault();
        $('#new_staff').modal('hide');
            open_loader('#page');

        var form = $("#create-form")[0];
        var _data = new FormData(form);
        $.ajax({
            url: '{{url("staff/create-data")}}',
            data: _data,
            enctype: 'multipart/form-data',
            processData: false,
            contentType:false,
