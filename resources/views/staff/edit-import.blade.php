                ...
                <div class="page-head-wrap">
                    ...
                    <div class="breadcrumb-right">
                        <ol class="breadcrumb">
                            ...
                            <li class="active">Edit Staff Import</li>
                        </ol>
                    </div>
                </div>
                <!--page header end-->
                                                ...
                                                <div class="modal-body">
                                                    <div class="form">
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-lg-9">
                                                                <input class=" form-control" id="staff_no" name="staff_no[]" value="{{$bl->staff_num}}" type="text" required="required"/>
                                                            </div>
                                                        </div>
                                                        <div class="form-group">
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-lg-9">
                                                                <input class=" form-control" id="edit_middle_name" name="middle_name[]" value="{{$bl->mid_name}}" type="text"/>
                                                            </div>
                                                        </div>
                                                        <div class="form-group">
                                                            <label for="title" class="control-label col-lg-3">Last Name</label>
                                                            <div class="col-lg-9">
                                                                <input class=" form-control" id="edit_last_name" name="last_name[]" value="{{$bl->sur_name}}" type="text" required="required"/>
                                                            </div>
                                                        </div>
                                                        <div class="form-group">
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-lg-9">
                                                                <input class=" form-control" id="edit_phone_number" name="phone_number[]" value="{{$bl->phone}}" type="tel" required="required"/>
                                                            </div>
                                                        </div>
                                                        <div class="form-group">
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-lg-9">
                                                                <input class=" form-control" id="edit_city" name="lga[]" value="{{$bl->lga}}" type="text" required="required"/>
                                                            </div>
                                                        </div>
                                                        <div class="form-group">
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-lg-9">
                                                                <input class=" form-control" id="staff_role" name="staff_role[]" value="{{$bl->staff_role}}" type="text" required="required"/>
                                                            </div>
                                                        </div>
                                                        <div class="form-group">
                                                            <label for="title" class="control-label col-lg-3">Position</label>
                                                            <div class="col-lg-9">
                                                                <input class=" form-control" id="position" name="position[]" value="{{$bl->staff_position}}" type="text" required="required"/>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div><br>
...
<script>
    $('#import-form').submit(function(e){
		...
		$.ajax({
			url: '{{url("staff/import-edited-data")}}',
			data: _data,
			...
			success: function(data){
				...
				if(data.status == "success"){
                    ...
                    setTimeout("window.location.href='{{url('staff/history')}}';");
                    close_loader('#page');
                    } else{
