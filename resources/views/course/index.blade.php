                ...
                <div class="modal-body">
                    <div class="form">
                        <div class="form-group">
                            <label for="title" class="control-label col-lg-3">Course Code</label>
                            <div class="col-lg-9">
                                <input class=" form-control" name="code" type="text" required="required"/>
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="title" class="control-label col-lg-3">Course Name</label>
                            <div class="col-lg-9">
                                <input class=" form-control" name="name" type="text" required="required"/>
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="title" class="control-label col-lg-3">Teacher</label>
                            <div class="col-lg-9">
                                <select class=" form-control" name="staff_id" required="required">
                ...
                <div class="modal-body">
                    <div class="form">
                        ...
                        <div class="form-group">
                            <label for="title" class="control-label col-lg-3">Teacher</label>
                            <div class="col-lg-9">
                                <select class=" form-control" id="edit_staff" name="staff_id" required="required">
                                    <option disabled selected>select teacher</option>
                                    @foreach($staff as $staf)
                                    <option value="{{$staf->id}}">{{$staf->fullname}}</option>
                                    @endforeach
		...
		$.ajax({
			...
			success: function(data){
				...
				if(data.status == "success"){
                    ...
                    $( "#datatable" ).load( "{{url('course/history')}} #datatable" );
                    close_loader('#page');
                    } else{
