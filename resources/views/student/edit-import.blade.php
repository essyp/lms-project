                ...
                <div class="page-head-wrap">
                    ...
                    <div class="breadcrumb-right">
                        <ol class="breadcrumb">
                            ...
                            <li class="active">Edit Student Import</li>
                        </ol>
                    </div>
                </div>
                <!--page header end-->
                                                ...
                                                <div class="modal-body">
                                                    <div class="form">
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-lg-9">
                                                                <input class=" form-control" id="edit_student_no" name="student_no[]" value="{{$bl->student_id}}" type="text" required="required"/>
                                                            </div>
                                                        </div>
                                                        <div class="form-group">
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-lg-9">
                                                                <input class=" form-control" id="edit_lga" name="lga[]" value="{{$bl->lga}}" type="text" required="required"/>
                                                            </div>
                                                        </div>
                                                        <div class="form-group">
                                                        ...
                                                        <div class="form-group">
                                                            <label for="title" class="control-label col-lg-3">Parrent Name</label>
                                                            <div class="col-lg-9">
                                                                <input class=" form-control" id="edit_parent_name" name="parent_name[]" value="{{$bl->parent_guardian}}" type="text" required="required"/>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div><br>
...
<script>
    $('#import-form').submit(function(e){
		...
		$.ajax({
			url: '{{url("student/import-edited-data")}}',
			data: _data,
			...
			success: function(data){
				...
				if(data.status == "success"){
                    ...
                    setTimeout("window.location.href='{{url('student/history')}}';");
                    close_loader('#page');
                    } else{
