                                    ...
                                    <div class="panel-body" style="overflow-x:auto;">
                                        <table id="datatable" class="table table-striped">
                                            ...
                                            <tr style="white-space: normal">
                                                ...
                                                <td>{{$bl->student_no}}</td>
                                                <td>{{$bl->student?$bl->student->fullname:''}}</td>
                                                <td>{{$bl->previous_class_code}} <br> {{$bl->previous_class_name}}</td>
                                                <td>{{$bl->next_class_code}} <br> {{$bl->next_class_name}}</td>
                                                <td>{{$bl->created_at}}</td>  
                                                <td>
                                                <div class="btn-group">
                                                <button data-toggle="dropdown" class="btn btn-default dropdown-toggle" type="button" aria-expanded="false">Action <span class="caret"></span></button>
...
<div  id="export" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <form class="cmxform form-horizontal" action="{{url('enrollment/export')}}" method="POST">
                @csrf
                <div class="modal-body">
                    <div class="form">
                        <div class="form-group">
            ...
            {{ csrf_field() }}
                <div class="modal-body">
                    <div class="form">
                        ...
                        <div class="form-group">
                            <label for="title" class="control-label col-lg-3">Previous Class</label>
                            <div class="col-lg-9">
                                <select class=" form-control" name="previous_id" required="required">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-lg-9">
                                <select class=" form-control" name="next_id" required="required">
                                    <option disabled selected>select class</option>
                                    @foreach($classes as $class)
                                    <option value="{{$class->id}}">{{$class->name}} - {{$class->code}}</option>
                                    @endforeach
                ...
                <div class="modal-body">
                    <div class="form">
                        <div class="form-group">
                            <label for="title" class="control-label col-lg-3">Student No</label>
                            <div class="col-lg-9">
                                <input class=" form-control" id="edit_student_no" name="student_no" type="text" required="required"/>
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="title" class="control-label col-lg-3">Previous Class</label>
                            <div class="col-lg-9">
                                <select class=" form-control" id="edit_previous_id" name="previous_id" required="required">
                                    <option disabled selected>select class</option>
                                    @foreach($classes as $class)
                                    <option value="{{$class->id}}">{{$class->name}} - {{$class->code}}</option>
                                    @endforeach
                        ...
                        <div class="form-group">
                            <label for="title" class="control-label col-lg-3">Next Class</label>
                            <div class="col-lg-9">
                                <select class=" form-control" id="edit_next_id" name="next_id" required="required">
                                    <option disabled selected>select class</option>
                                    @foreach($classes as $class)
                                    <option value="{{$class->id}}">{{$class->name}} - {{$class->code}}</option>
                                    @endforeach
